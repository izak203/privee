...
<div class="container-fluid mt-4">
   <h1 class="mb-4 title_primaire_ecole">Matérnelle</h1>
   <h2>Moyenne Section</h2>
</div>
<div class="container mt-4">
   ...
   <div class="row">
      ...
      <h1><a href="{{ route('home.quiz.maternelle.quizmoyennesectionquiz') }}" class="btn btn-primary">Repondre les Quiz test</a></h1>
