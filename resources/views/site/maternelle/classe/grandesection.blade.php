...
<div class="container-fluid mt-4">
   <h1 class="mb-4 title_primaire_ecole">Maternelle</h1>
...
<div class="row">
   ...
   <h1><a href="{{ route('home.quiz.maternelle.quizgrandesectionquiz') }}" class="btn btn-primary">Repondre les Quiz test</a></h1>
