...
<div class="container-fluid mt-4">
   <h1 class="mb-4 title_primaire_ecole">Module Numérice</h1>
   <h2>Djoomla Wordpress</h2>
</div>
...
<div class="row">
   ...
   <h1><a href="{{ route('home.quiz.numeric.quiznumericwordpressdjoomlaquiz') }}" class="btn btn-primary">Repondre les Quiz test</a></h1>
